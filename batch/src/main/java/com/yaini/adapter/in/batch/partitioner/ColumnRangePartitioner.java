package com.yaini.adapter.in.batch.partitioner;
...
public class ColumnRangePartitioner implements Partitioner {
   ...
   * distributed. The execution context values will have keys <code>minValue</code> and <code>
   * maxValue</code> specifying the range of values to consider in each partition.
   *
